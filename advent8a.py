...
regList1 = [re.findall('[a-z]+', i)[0] for i in indata.split('\n')]

funcList = [re.findall('[a-z]+', i)[1].replace('inc', '+').replace('dec', '-') for i in indata.split('\n')]

valList1 = [re.findall('[-\d+]+', i)[0] for i in indata.split('\n')]

regList2 = [re.findall('[a-z]+', i)[3] for i in indata.split('\n')]

boolList = [re.findall('[<>=!]+', i)[0] for i in indata.split('\n')]

valList2 = [re.findall('\d+', i)[1] for i in indata.split('\n')]
